...
pub enum Action {
    ...
    /// Move the focused window up in a column, or to a smart workspace above.
    MoveWindowUpOrToSmartWorkspaceUp {
        /// Whether the focus should follow the target workspace.
        ///
        /// If `true` (the default), the focus will follow the window to the new workspace. If
        /// `false`, the focus will remain on the original workspace.
    ...
    /// Move the focused window down in a column, or to a smart workspace below.
    MoveWindowDownOrToSmartWorkspaceDown {
        /// Whether the focus should follow the target workspace.
        ///
        /// If `true` (the default), the focus will follow the window to the new workspace. If
        /// `false`, the focus will remain on the original workspace.
